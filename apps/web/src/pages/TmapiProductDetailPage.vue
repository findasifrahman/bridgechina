        ...
        <div class="min-w-0 space-y-3">
          <div class="grid gap-3 xl:grid-cols-[minmax(0,0.86fr)_minmax(0,0.9fr)]">
            <section class="rounded-[22px] border border-slate-200 bg-white p-3 shadow-[0_16px_38px_rgba(15,23,42,0.05)]">
              ...
              <div v-if="product.shippingInfo" class="mt-4 rounded-[18px] border border-slate-200 bg-gradient-to-r from-teal-50 to-amber-50 p-3.5">
            ...
            <section class="rounded-[22px] border border-slate-200 bg-white p-4 shadow-[0_16px_38px_rgba(15,23,42,0.05)] sm:p-4">
              ...
              <div class="mt-3.5">
                ...
                <div v-else class="grid gap-3 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-end">
                  ...
                  <div v-if="totalQuantity > 0 && (product.priceMin || product.tieredPricing)" class="rounded-[16px] border border-teal-200 bg-teal-50 px-3 py-2 text-[11px]">
...
function getUnitPrice(): number {
  ...
  return product.value.priceMin || 0;
}
