...
function normalizeLocalProductCard(product: any, mediaById: Map<string, any> = new Map()) {
  ...
  return {
    ...
    vendorId: (product as any).vendor_id || undefined,
    shopUrl: (product as any).shop_url || undefined,
    productUrl: (product as any).product_url || product.source_url || undefined,
