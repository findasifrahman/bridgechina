<template>
  <div class="min-h-screen bg-slate-50 flex flex-col lg:flex-row">
    <aside
      class="w-full border-b border-slate-200 bg-slate-50/50 lg:sticky lg:top-0 lg:h-screen lg:w-64 lg:border-b-0 lg:border-r lg:overflow-y-auto"
    >
        ...
        >
          <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              ...
              stroke-linejoin="round"
              stroke-width="2"
              d="M5 13l4 4L19 7m-7 13a9 9 0 100-18 9 9 0 000 18z"
            />
          </svg>
          <span>Orders</span>
        </router-link>
        ...
        >
          <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              ...
              stroke-linejoin="round"
              stroke-width="2"
              d="M17 20h5v-2a4 4 0 00-5.33-3.77M9 20H4v-2a4 4 0 015.33-3.77M12 12a4 4 0 100-8 4 4 0 000 8zm0 0c2.67 0 5 1.34 5 3v1H7v-1c0-1.66 2.33-3 5-3z"
            />
          </svg>
        ...
        >
          <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              ...
              stroke-linejoin="round"
              stroke-width="2"
              d="M11 5a6 6 0 104.472 9.999l3.765 3.764a1 1 0 001.414-1.414l-3.764-3.765A6 6 0 0011 5zm0 3a3 3 0 110 6 3 3 0 010-6z"
            />
          </svg>
        ...
        >
          <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              ...
              stroke-linejoin="round"
              stroke-width="2"
              d="M5 7h14l1 10H4L5 7zm4-3h6v3H9V4zm0 7h6m-6 4h4"
            />
          </svg>
